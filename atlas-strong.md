...
A lot of the apparatus built to sort people — gates, rankings, permanent records — only exists to serve someone else's hiring decision. Remove the wage-labor relationship that requires sorting, and the apparatus has nothing left to be *for*. What survives isn't hierarchy — it's differentiation: some tasks need real skill, some people are better suited to them, and that can be handled through trust and reputation built over time instead of a single gatekept moment at seventeen.

### 8. The Coke bottle
*The Gods Must Be Crazy*: a single scarce object dropped into a community with no prior concept of exclusive possession invents envy, conflict, hierarchy — not because it revealed something latent in people, but because scarcity manufactures the problem it appears to merely expose. The resolution isn't winning the bottle. It's throwing it off the edge of the world — and the guerrillas fighting a war over a fiction is the same lesson at the scale of nations: the thing being fought over has no substance independent of the fight.
